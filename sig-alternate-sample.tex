...
To accomplish our objective of integrating node attributes in a probabilistic framework, we will \rk{model} connectivity in a network with the widely-used stochastic block model \rk{(SBM)} \cite{hollandSBM}. Finish writing about the model and the typical crap
