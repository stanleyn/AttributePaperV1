...
Here, ${\bf x}_{i}$ and ${\bf a}_{i}$ denote the attribute and connectivity patterns for node $i$, respectively. In particular, ${\bf a}_{i}$ is the $i$th row of the adjacency matrix, ${\bf A}$. Therefore, the $j$th entry of ${\bf a}_{i}$ is 1 if nodes $i$ and $j$ are connected and 0 otherwise. 
\vskip1ex
